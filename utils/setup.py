...
from galore_torch import GaLoreAdamW, GaLoreAdamW8bit, GaLoreAdafactor, QGaLoreAdamW8bit, QGaLoreAdamW8bit_simulate, SPAMAdam,STABLEAdam,STABLEAdam1,Adam_mini_our
...
def setup_optimization(args, model, trainable_params, param_groups, id_galore_params,model_config=None):
    ...
    if args.optimizer.lower() == "adam":
        ...
        optimizer = Lion_we(model.parameters(), lr=args.lr, weight_decay=args.weight_decay,gamma1 = args.gamma1, gamma2 = args.gamma2, theta = args.theta)
        ...
        optimizer = SPAMAdam(param_groups, lr = args.lr, weight_decay = args.weight_decay)
        ########################################################
    elif args.optimizer.lower() == "stablespam":
        optimizer = STABLEAdam(trainable_params, lr = args.lr, weight_decay = args.weight_decay,gamma1=args.gamma1,gamma2=args.gamma2,theta=args.theta,eta_min=args.eta,update_proj_gap=args.update_proj_gap,total_T=args.total_T)
    elif args.optimizer.lower() == "stablespam1":
        optimizer = STABLEAdam1(trainable_params, lr = args.lr, weight_decay = args.weight_decay,gamma1=args.gamma1,gamma2=args.gamma2,theta=args.theta,eta_min=args.eta,update_proj_gap=args.update_proj_gap,total_T=args.total_T)
